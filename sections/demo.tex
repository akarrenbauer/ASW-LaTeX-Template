...
\subsection{Fließelemente}
 ...
 \subsubsection{Bilder}
    \begin{wrapfigure}{r}{0.45\linewidth}
      ...
      \caption[Aufbau von \acrlong{MVC}]{Aufbau von \gls{MVC}.\\Quelle: Angelehnt an~\cite{curry2008flexible}}\label{fig_mvc}
    \end{wrapfigure}
    ...
    \begin{figure}[tbh]
      ...
      \caption{Einblick in die Entwicklungsumgebung Visual Studio Code}\label{fig_prototyp_desktop}
    \end{figure}
...
\subsubsection{Tabellen}
  ...
  \begin{table}[tb]
    ...
    \end{tabular}
    \caption{Übersicht besetzter und geplanter Stellen im Unternehmen}\label{tbl_proglang}
  \end{table}
...
\subsection{Zitate}
  ...
  \subsubsection{Inline Zitat}
    \enquote{\gls{AWATAD}}\footcite[S. 2703]{timmerer2019journey}, zu deutsch überall, jederzeit, auf jedem Gerät,
  ...
  \subsubsection{Blockzitat}
    ...
    \begin{quotation}
      \enquote{Zielorientierte Bereitstellung und systematische Verwendung von Prinzipien, Methoden und Werkzeugen
...
\subsection{Textstrukturierung}
  \subsubsection{Gliederungsebenen}
    ...
    \begin{itemize}
      \item sections stellen die oberste Ebene dar und werden in dieser Demo in der Datei textteil.tex definiert.
